...
typedef SWIFT_ENUM_NAMED(NSInteger, MMBLEUpgradeStartResult, "MMBLEUpgradeStartResult", open) {
  MMBLEUpgradeStartResultSuccess = 0,
  MMBLEUpgradeStartResultFaild = 1,
  MMBLEUpgradeStartResultUnConnectDevice = 2,
};

typedef SWIFT_ENUM_NAMED(NSInteger, MMBLEUpgradeStatus, "MMBLEUpgradeStatus", open) {
...
typedef SWIFT_ENUM_NAMED(uint8_t, MMDeviceCoverStatus, "MMDeviceCoverStatus", open) {
...
typedef SWIFT_ENUM_NAMED(uint8_t, MMDevicePaperStatus, "MMDevicePaperStatus", open) {
  MMDevicePaperStatusNormal = 0,
  MMDevicePaperStatusLack = 1,
};

typedef SWIFT_ENUM_NAMED(uint8_t, MMDeviceTempStatus, "MMDeviceTempStatus", open) {
...
typedef SWIFT_ENUM_NAMED(NSInteger, MMUpdateType, "MMUpdateType", open) {
  MMUpdateTypeNone = 0,
  MMUpdateTypeFirm = 1,
